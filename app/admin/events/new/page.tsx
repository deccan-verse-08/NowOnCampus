            ...
            <div className="bg-white border-b border-slate-200 px-4 sm:px-6 lg:px-8 py-5">
                <div className="max-w-4xl mx-auto flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-lg font-bold text-slate-900">Create New Event</h1>
                            <p className="text-xs text-slate-500">Fill in the details below to publish an event</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                {success ? (
                    <div className="flex flex-col items-center justify-center py-20 text-center">
                        ...
                        <h2 className="text-xl font-bold text-slate-900 mb-2">Event Created!</h2>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="bg-white rounded-2xl border border-slate-200 p-6 space-y-4">
                            ...
                            <div>
                                <label className={labelClass}>
                                    <FileText className="w-3.5 h-3.5 text-slate-400" /> Short Description
                                </label>
                                <input
                                    type="text"
                        ...
                        <div className="bg-white rounded-2xl border border-slate-200 p-6 space-y-4">
                            <h2 className="font-bold text-slate-900 flex items-center gap-2 pb-2 border-b border-slate-100">
                                <CalendarPlus className="w-4 h-4 text-blue-600" /> Date & Registration
                            </h2>
                        ...
                        <div className="bg-white rounded-2xl border border-slate-200 p-6 space-y-4">
                            <h2 className="font-bold text-slate-900 flex items-center gap-2 pb-2 border-b border-slate-100">
                                <Trophy className="w-4 h-4 text-blue-600" /> Additional Details
                            </h2>

                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                <div>
                                    <label className={labelClass}>
                                        <Users className="w-3.5 h-3.5 text-slate-400" /> Max Participants
                                    </label>
                                    <input
                                        type="number"
                                ...
                                <div>
                                    <label className={labelClass}>
                                        <Trophy className="w-3.5 h-3.5 text-slate-400" /> Prize Money
                                    </label>
                                    <input
                                        type="text"
                            ...
                            <div>
                                <label className={labelClass}>
                                    <ImageIcon className="w-3.5 h-3.5 text-slate-400" /> Banner Image URL
                                </label>
                                <input
                                    type="url"
                                    value={form.image}
                        ...
                        <div className="flex items-center justify-end gap-4 pb-4">
                            <Link href="/admin" className="px-5 py-2.5 text-sm font-medium text-slate-600 hover:bg-slate-100 rounded-xl transition-colors">
                                Cancel
                            </Link>
                            <button
                                type="submit"

              ...
              >
                <div className="flex-1 p-8 md:p-14 flex flex-col justify-center relative">
                  ...
                  <div className="max-w-sm mx-auto w-full text-center md:text-left">
                    <div className="w-12 h-12 rounded-2xl bg-orange-500 flex items-center justify-center mb-6 shadow-lg shadow-orange-500/20 mx-auto md:mx-0">
                      <Sparkles className="text-white" />
                    </div>
                    <h2 className="text-3xl font-black text-slate-900 mb-2 uppercase italic leading-tight">
                      Fresh start <br /> starts here
                    </h2>
                    <p className="text-slate-400 text-sm font-medium mb-8">
                      Join the wave of 50k+ students.
